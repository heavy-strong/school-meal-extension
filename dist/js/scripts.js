...
/* harmony import */ var _getMenu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _getYmd__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function() {
    ...
    chrome.storage.sync.get(["breakfast", "lunch", "dinner", "date"], function(result) {
        ...
        if (result.date === Object(_getYmd__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date())) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#breakfast > ul").html(result.breakfast);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lunch > ul").html(result.lunch);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dinner > ul").html(result.dinner);
        } else {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btn-today").text(Object(_getYmd__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date()));
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", ".school-list", function() {
    ...
    name = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)
        .find("h3")
        .text();
...
// loading...
function loading() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#breakfast > ul").html("불러오는 중...");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lunch > ul").html("불러오는 중...");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dinner > ul").html("불러오는 중...");
}

// 급식메뉴 불러와서 데이터 삽입
function getMenuFront(ymd, callback) {
    chrome.storage.sync.get(keys, function(setting) {
        Object(_getMenu__WEBPACK_IMPORTED_MODULE_1__["default"])(ymd, setting, (time, data) => {
